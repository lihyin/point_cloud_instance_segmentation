...
Since we don't have ground truth, we use sklearn HDBSCAN output as the pseudo ground truth to crosscheck and calculate our implementation's following [Clustering Performance Evaluation Metrics](https://scikit-learn.org/stable/modules/clustering.html#clustering-performance-evaluation):
